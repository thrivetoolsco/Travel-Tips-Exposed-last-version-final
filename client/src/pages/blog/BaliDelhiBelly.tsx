            ...
            <div className="flex gap-3 p-4 bg-card border border-card-border rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  I get mine <a href="https://justthrivehealth.com/THRIVETOOLS" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:text-teal-500 font-semibold">HERE</a>. You can use my discount code <strong>THRIVETOOLS</strong>. They're a powerful strain of probiotics.
                </p>
              </div>
            </div>
            <div className="flex gap-3 p-4 bg-card border border-card-border rounded-xl">
