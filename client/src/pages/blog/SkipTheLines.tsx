        ...
        <div className="prose prose-lg max-w-none text-foreground" style={{ fontFamily: "var(--font-sans)" }} data-testid="post-body">
          ...
          <div className="space-y-8 my-10">
            <div className="p-6 bg-card border border-card-border rounded-xl">
              <h3 className="text-xl font-bold mb-3 text-violet-400" style={{ fontFamily: "var(--font-serif)" }}>
              ...
              <a href="https://evisa.imigrasi.go.id/" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-violet-400 hover:text-violet-400 font-semibold text-sm">
          ...
          <div className="my-10 p-6 border border-violet-500/20 bg-violet-950/30 bg-orange-950/10 rounded-xl text-center">
            ...
            <p className="text-violet-400 font-bold text-lg mt-4">Your Indonesia trip is about to start. Go get that coconut.</p>
          </div>
        </div>
