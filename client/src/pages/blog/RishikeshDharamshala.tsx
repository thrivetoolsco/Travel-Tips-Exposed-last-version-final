      ...
      <div className="max-w-4xl mx-auto px-4 py-12" data-testid="post-content">
        ...
        <div className="prose prose-lg max-w-none text-foreground" style={{ fontFamily: "var(--font-sans)" }} data-testid="post-body">
          ...
          <div className="space-y-6 my-8">
            ...
            <div className="flex gap-4 p-5 bg-card border border-card-border rounded-xl">
              <span className="text-2xl font-bold text-teal-600" style={{ fontFamily: "var(--font-display)" }}>4.</span>
              <div>
          ...
          <div className="my-10 p-6 border border-teal-200 dark:border-teal-800 bg-teal-50 dark:bg-teal-900/10 rounded-xl text-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 mt-4 px-6 py-3 bg-teal-600 hover:bg-teal-500 text-white font-semibold text-sm tracking-wider uppercase rounded-md transition-all duration-200"
              style={{ fontFamily: "var(--font-display)" }}
            >
